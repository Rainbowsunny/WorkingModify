...
<head>
	...
	$(function() {	
	    ...
	    $("#passwordDialog").dialog({
	    	...
	    	width: 500,
	    	height: 300,
	    	iconCls: "icon-add", //显示在标签页面板（tab panel）标题上的图标的 CSS class
	    	modal: true,
	    	collapsible: false,
	    	minimizable: false,
	    	maximizable: false,
	...
	<div id="editDialog" style="padding: 20px">
    	...
    	<form id="editForm">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>学院:</td>
	    			<td><input id="edit_college"  value="${userDetail.major }" style="width: 200px; height: 30px;" class="easyui-textbox" data-options="readonly: true"/></td>
	    		</tr>
	    		<tr>
	    			<td>专业:</td>
	    			<td><input id="edit_major"  value="${userDetail.college}" style="width: 200px; height: 30px;" class="easyui-textbox" data-options="readonly: true"/></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
